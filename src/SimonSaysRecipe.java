...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 		images.put(new Integer(KeyEvent.VK_RIGHT), "download-1.jpg");
 		images.put(new Integer(KeyEvent.VK_LEFT), "download.jpg");
 		images.put(new Integer(KeyEvent.VK_DOWN), "download.png");
